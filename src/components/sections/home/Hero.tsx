...
const DEFAULT_HERO = {
  badge: 'Authentic Italian Dining Since 1985',
  title: 'Experience the taste of',
  titleHighlight: 'Bella Vista',
  subtitle:
    'Indulge in authentic Italian cuisine crafted with passion, using the finest imported ingredients and traditional family recipes passed down through generations.',
  primaryCTA: 'Reserve Table',
  secondaryCTA: 'View Menu',
  primaryCTAHref: '/reservations',
  secondaryCTAHref: '/menu',
  feature1Icon: 'zap',
  feature1Text: 'Fresh daily ingredients',
  feature2Icon: 'shield',
  feature2Text: 'Family recipes',
  feature3Icon: 'globe',
  feature3Text: 'Authentic Italian',
  trustedByText: 'Loved by food enthusiasts and critics alike',
